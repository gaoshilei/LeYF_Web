...
export const asyncRoutes = [
...

  {
    ...
    children: [
      {
        path: 'log',
        component: () => import('@/admin/views/error-log/index'),
        name: 'ErrorLog',
...

  {
    ...
    children: [
      {
        path: 'download',
        component: () => import('@/admin/views/zip/index'),
        name: 'ExportZip',
...

  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('@/admin/views/theme/index'),
        name: 'Theme',
...

  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('@/admin/views/clipboard/index'),
        name: 'ClipboardDemo',
